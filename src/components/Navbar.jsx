...
function Navbar({ modalMode, onClick }) {
    ...
    return (
        <div className={`navbar-container absolute transition-opacity duration-300 ${visible ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
            <nav className='text-black text-lg sm:text-xl xl:text-2xl flex justify-center sm:justify-end items-center fixed top-5 right-5 left-5 sm:left-auto z-100 bg-transparent'>
