...
function Skill({ title, description, type, icon, iconSize="w-3/4 h-3/4", link }) {
    ...
    return(
        <a
            ...
            className="w-full"
        >
            <div className={`skill hover:scale-105 hover:shadow-xl cursor-pointer transition-all duration-200
                h-12
                md:h-14
                lg:h-16
                2xl:h-20
